...
import static com.event.practice.eventcarriedstatetransferdemopublisher.service.EventPublisherService.FANOUT_EXCHANGE;
import static com.event.practice.eventcarriedstatetransferdemopublisher.service.EventPublisherService.FANOUT_EXCHANGE_QUEUE_1;
import static com.event.practice.eventcarriedstatetransferdemopublisher.service.EventPublisherService.FANOUT_EXCHANGE_QUEUE_2;
import static com.event.practice.eventcarriedstatetransferdemopublisher.service.EventPublisherService.FANOUT_EXCHANGE_QUEUE_3;
import static com.event.practice.eventcarriedstatetransferdemopublisher.service.EventPublisherService.TOPIC_EXCHANGE;
import static com.event.practice.eventcarriedstatetransferdemopublisher.service.EventPublisherService.TOPIC_EXCHANGE_ORDER_ROUTING_KEY;
import static com.event.practice.eventcarriedstatetransferdemopublisher.service.EventPublisherService.TOPIC_EXCHANGE_QUEUE;
